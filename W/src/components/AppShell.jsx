...
export default function AppShell({ profile, title, children }) {
  ...
  const navByRole = {
    pet_owner: [
      ...
      { label: "Notifications", to: "/pet-owner/notifications", type: "notification" },
      { label: "My Profile", to: "/pet-owner/profile", type: "profile" }
    ],
    staff: [
      ...
      { label: "Notifications", to: "/staff/notifications", type: "notification" },
      { label: "My Profile", to: "/staff/profile", type: "profile" }
    ],
    veterinarian: [
      ...
      { label: "Inventory", to: "/veterinarian/inventory", type: "inventory" },
      { label: "Messages", to: "/veterinarian/messages", type: "message" },
      { label: "Notifications", to: "/veterinarian/notifications", type: "notification" },
      { label: "My Profile", to: "/veterinarian/profile", type: "profile" }
    ],
    admin: [
      ...
      { label: "Notifications", to: "/admin/notifications", type: "notification" },
      { label: "My Profile", to: "/admin/profile", type: "profile" }
    ]
  };
