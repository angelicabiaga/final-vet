...
export default function MessagingModule({ profile }) {
  ...
  useEffect(() => {
    ...
    const channel = subscribeToMessagingOverview(profile.id, loadConversations);
    return () => {
