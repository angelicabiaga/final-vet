...
--
-- This is every SQL fix from this session bundled into a single file, in the
-- correct order, so you only have to paste and run one thing. Every piece
-- inside is safe to run even if some of it is already live in your database
-- (everything uses "create or replace" / "create table if not exists" /
-- "drop ... if exists" -- nothing here can duplicate data or break by being
-- run twice).
--
-- HOW TO RUN THIS:
...
--   6. You should see "Success. No rows returned" at the bottom -- that's it.
--
-- What this unlocks once it's run:
--   * The FEFO batch deduction fix (POS deducts the batch closest to
--     expiring first, not just the oldest-received one).
--   * The "Merge into this item" button in the Inventory item details modal
--     actually works now -- it will merge duplicate items like your two
--     "2 WAY TEST" / "3 WAY TEST" rows into one.
--   * A voided/expired GCash transaction correctly rolls back the
--     "purchased quantity" it had optimistically counted, instead of
--     permanently over-counting a prescription as bought.
-- ============================================================================


-- ============================================================================
-- PART 1 of 5: VOID_TRANSACTION_FUNCTION.sql
-- ============================================================================
...
-- ============================================================================
-- PART 2 of 5: FIFO_INVENTORY_BATCHES.sql
-- ============================================================================
...
-- ============================================================================
-- PART 3 of 5: INVENTORY_FEFO_DEDUCTION.sql
-- ============================================================================
...
-- ============================================================================
-- PART 4 of 5: PRESCRIPTION_VOID_ROLLBACK.sql
-- ============================================================================
...
-- ============================================================================
-- PART 5 of 5: INVENTORY_MERGE_DUPLICATES.sql
-- ============================================================================
